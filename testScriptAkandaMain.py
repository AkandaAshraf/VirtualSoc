...
# #
G2 = RandomSocialGraphAdvanced(labelSplit=[500,1000,5000],connectionPercentageWithMatchedNodes=30,connectionPercentageWithMatchedNodesWithRandomness=0.5,explorationProbability=0.3,addTraidtionalFeatures=True,additionalFeatureLen=2, npDistFunc=['np.random.randint(10, high=20)','np.random.binomial(2, 0.5)'],popularityPreferenceIntensity=1,mutualPreferenceIntensity=[3,2,1],genFeaturesFromSameDistforAllLabel=False,keepHistory=False)
...
# G2.writeFileA('D:\\testVirtualSoc\\testAdjFile.txt')
#
WriteToFile(G2).easySaveEverything('D:\\VirtualSocGCN\\ShuffledDNATest\\')
