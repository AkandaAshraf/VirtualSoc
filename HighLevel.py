...
def simulateNetworksEasy2(folderPath):
    explorationProbabilityV = np.linspace(0.01,0.1,3)
    popularityPreferenceIntensityV = np.linspace(0.5,1.5,7)

    connectionPercentageWithMatchedNodesV = np.linspace(0.5,2,3)
    mutualPreferenceIntensityV = []
    len2 = np.random.uniform(low=0.7, high=1.0, size=10)
    len3 = np.random.uniform(low=0.3, high=0.7, size=10)
    len4 =  np.random.uniform(low=0.0, high=0.3, size=10)
